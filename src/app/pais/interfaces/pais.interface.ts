...
//
//   const setCountries = Convert.toSetCountries(json);
//
...
export class Convert {
    public static toSetCountries(json: string): Country[] {
        return cast(JSON.parse(json), a(r("SetCountries")));
    }

    public static setCountriesToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("SetCountries"))), null, 2);
    }
}
